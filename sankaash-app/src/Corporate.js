      ...
      <section id="corporate" className="corporate">
        <div className="container">
          ...
          <div className="corporate-services">
            ...
            <div className="corporate-service">
              <h4>Genetic Brain Profiling</h4>
              <ul>
                <li>Decodes Team Brain Profiles — Understand how your team members naturally think and process information</li>
                <li>Matches Roles to Strengths — Align responsibilities with innate capabilities for optimal performance</li>
                <li>Builds lasting Resilience — Develop emotional strength and adaptability across your organization</li>
              </ul>
            </div>
